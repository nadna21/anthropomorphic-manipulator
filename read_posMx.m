...
function  dxl_present_position = read_posMx(x,DXL_ID)
lib_name = '';
...
if DXL_ID == 1
dxl_present_position = map1M2R(dxl_present_position);
end

if DXL_ID == 2
dxl_present_position = map2M2R(dxl_present_position);
end

if DXL_ID == 3
dxl_present_position = map3M2R(dxl_present_position);
end
